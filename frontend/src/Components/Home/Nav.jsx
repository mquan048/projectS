  ...
  return (
    <header className="header-login">
      <span className="container-logo-university">
        <span>
          <img src={logoBK} alt="Logo Trường đại học BK"></img>
        </span>
  ...
  return (
    <nav className="navbar">
      <ul className="nav-items">
        ...
        >
          <span className="faHouse">
            <FontAwesomeIcon icon={faHouse} />
          </span>
        </li>

        <li
          className={`nav-item ${activeTab === "introduce" ? "active" : ""}`}
        ...
        <li
          className={`nav-item ${activeTab === "regulation" ? "active" : ""}`}
      ...
      <button className="login-button" onClick={handleStartPrinting}>
        Đăng nhập
      </button>
    </nav>
  );
